...
const features = [
  {
    title: "Potrivire AI",
    description:
      "Algoritmul nostru avansat de AI analizează profilul tău și te conectează cu joburile potrivite.",
    icon: <CheckCircle className="h-6 w-6" />,
  },
  {
    title: "Optimizare CV",
    description:
      "Primește sugestii personalizate pentru a-ți îmbunătăți CV-ul și a-ți crește șansele de angajare.",
    icon: <TrendingUp className="h-6 w-6" />,
  },
  {
    title: "Recomandări de joburi",
    description:
      "Descoperă oportunități de carieră adaptate perfect profilului și aspirațiilor tale.",
    icon: <Briefcase className="h-6 w-6" />,
  },
  {
    title: "Recrutare de talente",
    description:
      "Angajatorii pot găsi rapid candidații ideali folosind tehnologia noastră de potrivire.",
...
const testimonials = [
  {
    ...
    company: "TechRO",
    quote:
      "Datorită JobMatch, mi-am găsit jobul de vis în doar două săptămâni!",
  ...
  },
  {
    ...
    quote:
      "JobMatch ne-a ajutat să găsim candidați excelenți pentru pozițiile dificil de ocupat.",
...
const blogPosts = [
  ...
  {
    title: "Cum să te pregătești pentru un interviu online",
    image: "/online-interview.jpg",
  },
  {
    title: "Tendințe în piața muncii pentru 2024",
    ...
    <div className="flex flex-col items-center">
      ...
      <section className="text-center py-20">
        <h1 className="text-4xl font-bold mb-4">
          Găsește jobul perfect cu inteligența artificială
        </h1>
        <p className="text-xl mb-8">
          JobMatch conectează candidații și angajatorii folosind tehnologie AI
          avansată
        </p>
      ...
      <section className="py-20">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Categorii de joburi populare
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {jobCategories.map((category, index) => (
              <Card
                key={index}
                className="text-center hover:bg-muted cursor-pointer transition-colors"
              >
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          ...
          <p className="mb-8">
            Descoperiți cum JobMatch poate îmbunătăți procesul dvs. de recrutare
            și vă poate ajuta să găsiți candidații ideali.
          </p>
